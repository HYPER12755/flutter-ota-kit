...
void main() {
  group('getUpdateInfo — app version strategy', () {
    ...
    test(
      'returns null when app version does not qualify for higher version',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000001',
    ...
    test(
      'target app version compatibility with available higher version',
      () async {
        final bundles = [
          _appVersionBundle(
    ...
    test(
      'applies update when higher semver-compatible bundle is available',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000001',
    ...
    test(
      'falls back to older enabled bundle when latest is disabled',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000002',
    ...
    test(
      'rollback if latest bundle is disabled and no other updates enabled',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000002',
    ...
    test(
      'forces rollback if no matching bundle exists for provided bundleId',
      () async {
        final update = await getUpdateInfo(
          [],
    ...
    test(
      'selects next available bundle even if shouldForceUpdate is false',
      () async {
        final bundles = [
          _appVersionBundle(
    ...
    test(
      'applies highest available bundle even if app version unchanged',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000005',
    ...
    test(
      'returns bundle when available bundle higher than minBundleId',
      () async {
        final bundles = [
          _appVersionBundle(
    ...
    test('rollback when current bundle disabled and only bundles below minBundleId', () async {
      final bundles = [
        _appVersionBundle(
          id: '0195715d-42db-7475-9204-31819efc2f1d',
          targetAppVersion: '1.0',
    ...
    test(
      'rollback when current bundle does not exist and only below minBundleId',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '0195715a-ce29-7c55-97d3-53af4fe369b7',
    ...
    test(
      'returns null when current bundle enabled and no updates available',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '0195715d-42db-7475-9204-31819efc2f1d',
    ...
    test(
      'rollback when current bundle does not exist and all below minBundleId',
      () async {
        final bundles = [
          _appVersionBundle(
    ...
    test('rollback to bundle when current does not exist and bundle between minBundleId and bundleId', () async {
      final bundles = [
        _appVersionBundle(
    ...
    test('updates bundles from the same channel', () async {
      ...
      final update = await getUpdateInfo(bundles, _appArgs(channel: 'beta'));
      expect(update, isNotNull);
      expect(update!.id, '00000000-0000-0000-0000-000000000001');
      expect(update.message, 'hello');
      expect(update.shouldForceUpdate, isFalse);
    ...
    test(
      'returns null when minBundleId is greater than current bundle',
      () async {
        final bundles = [
          _appVersionBundle(
    ...
    test(
      'returns null when no bundles and minBundleId equals bundleId',
      () async {
        final update = await getUpdateInfo(
          [],
          _appArgs(
    ...
    test('applies update when bundle higher than minBundleId and bundleId equals minBundleId', () async {
      final bundles = [
        _appVersionBundle(
    ...
    test(
      'returns null for bounded range >= 5.7.0 <= 5.7.4 with version 5.7.5',
      () async {
        final bundles = [
          _appVersionBundle(
            id: '00000000-0000-0000-0000-000000000001',
    ...
    test('applies update when many distinct target app versions are compatible', () async {
  ...
  group('getUpdateInfo — fingerprint strategy', () {
    ...
    test(
      'fingerprint hash compatibility with available higher version',
      () async {
        final bundles = [
          _fingerprintBundle(
            id: '01963024-c131-7971-8725-ab47e232df41',
    ...
    test(
      'applies update when higher fingerprint-matching bundle available',
      () async {
        final bundles = [
          _fingerprintBundle(
            id: '00000000-0000-0000-0000-000000000001',
    ...
    test(
      'applies highest available bundle even if fingerprint unchanged',
      () async {
        final bundles = [
          _fingerprintBundle(
            id: '00000000-0000-0000-0000-000000000005',
  ...
  group('getUpdateInfo — gradual rollout (app version)', () {
    test('returns null when rolloutCohortCount is 0', () async {
      ...
      final update = await getUpdateInfo([bundle], _appArgs(cohort: '1'));
      expect(update, isNull);
    });
    ...
    test(
      'keeps numeric rollout active when targetCohorts are configured',
      () async {
    ...
    test('includes targeted numeric cohorts outside the rollout set', () async {
      ...
      final targetedNumericCohort = _findNumericCohort(
        bundleId,
        (pos) => pos >= 200,
      );
    ...
    test('returns latest eligible update when newer bundle targets different cohort', () async {
      final eligibleBundleId = '00000000-0000-0000-0000-000000000020';
      final blockedBundleId = '00000000-0000-0000-0000-000000000021';
      final eligibleCohort = _findNumericCohort(
        eligibleBundleId,
        (pos) => pos < 200,
      );
    ...
    test('re-evaluates current bundle eligibility and rolls back', () async {
      ...
      ], _appArgs(bundleId: currentBundleId, cohort: '1'));
      expect(update, isNotNull);
  ...
  group('getUpdateInfo — gradual rollout (fingerprint)', () {
    test('returns null when rolloutCohortCount is 0', () async {
      ...
      final update = await getUpdateInfo([bundle], _fpArgs(cohort: '1'));
      expect(update, isNull);
    });
    ...
    test('excludes custom cohorts from gradual rollout', () async {
      ...
      final update = await getUpdateInfo([bundle], _fpArgs(cohort: 'qa-group'));
      expect(update, isNull);
    });
    ...
    test('re-evaluates current bundle eligibility and rolls back', () async {
      ...
      ], _fpArgs(bundleId: currentBundleId, cohort: '1'));
      expect(update, isNotNull);
      expect(update!.id, previousBundleId);
      expect(update.shouldForceUpdate, isTrue);
      expect(update.status, UpdateStatus.rollback);
